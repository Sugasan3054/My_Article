...
export function initAurora(containerSelector = '#aurora-bg', options = {}) {
  ...
  const program = new Program(gl, {
    ...
    uniforms: {
      ...
      uColorStops: { value: getColorArray(config.colorStops) },
  ...
  if (window.matchMedia) {
    ...
    colorSchemeQuery.addEventListener('change', (e) => {
      const newColors = e.matches
        ? ['#002966', '#0070e0', '#58a6ff']
        : ['#004098', '#00a6fb', '#bfe0ff'];
      program.uniforms.uColorStops.value = getColorArray(newColors);
    });
  }
  ...
  const update = (t) => {
    ...
    const speed = isReducedMotion ? 0.05 : config.speed;
